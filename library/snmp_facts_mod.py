...
# Modified with additional OIDs by Peter.Rubenstein@marriott.com @prube194
...
ansible_interfaces:
  ...
  ansible_productname:
    ...
    type: str
    sample: "J9850A"
  ansible_lldpLocSysDesc:
    description: The LLDP system description of the device.
    returned: success
    type: str
    sample: "Aruba JL076A 3810M-40G-8SR-PoE+-1-slot Switch, revision KB.16.03.0003, ROM KB.16.01.0008 (/ws/swbuildm/rel_tacoma_qaoff/code/build/bom(swbuildm_rel_tacoma_qaoff_rel_tacoma))"
'''
...
class DefineOid(object):
    ...
    def __init__(self, dotprefix=False):
        ...
        self.productName = dp + "1.3.6.1.2.1.47.1.1.1.1.13.1"
        ...
        # From LLDP-MIB
        self.lldpLocSysDesc = dp + "1.0.8802.1.1.2.1.3.4.0"
...
def main():
    ...
    errorIndication, errorStatus, errorIndex, varBinds = cmdGen.getCmd(
        ...
        cmdgen.MibVariable(p.productName,),
    ...
    for oid, val in varBinds:
        ...
        elif current_oid == v.productName:
            results['ansible_productname'] = current_val
        elif current_oid == v.lldpLocSysDesc:
            results['ansible_lldpLocSysDesc'] = current_val
